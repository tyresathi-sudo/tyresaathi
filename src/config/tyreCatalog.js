...
export const SAMPLE_SHOPS = [
  {
    id: "shop-muz-central",
    name: "TyreSaathi Partner Hub — Motijheel",
    ownerName: "Verified Partner",
    phone: "",
    rating: 4.8,
    reviewsCount: 128,
    address: "Near Auto Market, Motijheel Road, Muzaffarpur, Bihar",
    city: "Muzaffarpur",
    distanceKm: 1.2,
    isNearest: true,
  ...
  {
    id: "shop-muz-south",
    name: "TyreSaathi Express Center — Gobarsahi",
    ownerName: "Verified Partner",
    phone: "",
    rating: 4.7,
    reviewsCount: 94,
    address: "Main Road, Near Gobarsahi Chowk, Muzaffarpur, Bihar",
    city: "Muzaffarpur",
    distanceKm: 2.8,
    isNearest: true,
    coordinates: { lat: 26.1150, lng: 85.3520 },
    servicesOffered: ["Tyre Sales", "Puncture Repair", "Doorstep Mobile Van"],
    isOpen: true
  },
  {
    id: "shop-delhi-ncr",
