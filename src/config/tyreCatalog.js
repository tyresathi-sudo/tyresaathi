...
export const SAMPLE_SHOPS = [
  {
    id: "shop-rpr-transport-nagar",
    name: "TyreSaathi Partner Hub — Transport Nagar",
    ...
    distanceKm: 0.8,
    isNearest: true,
    coordinates: { lat: 21.3217, lng: 81.6575 },
    servicesOffered: ["Tyre Replacement", "Cut Repair", "Wheel Alignment", "Nitrogen Air", "Truck & Car Radial"],
    isOpen: true
  },
  {
    id: "shop-rpr-ring-road",
    name: "TyreSaathi Express Center — Rawabhatha",
    ownerName: "Verified Partner",
    phone: "",
    rating: 4.8,
    reviewsCount: 98,
    address: "Industrial Area Road, Rawabhatha, Raipur, Chhattisgarh",
    city: "Raipur",
    distanceKm: 1.5,
    isNearest: true,
    coordinates: { lat: 21.3280, lng: 81.6620 },
    servicesOffered: ["Tyre Sales", "Puncture Repair", "Doorstep Mobile Van", "Laser Balancing"],
    isOpen: true
  },
  {
    id: "shop-delhi-ncr",
    ...
    rating: 4.9,
    reviewsCount: 210,
    address: "Auto Market Sector, Ring Road Area, New Delhi, Delhi NCR",
    city: "Delhi NCR",
    distanceKm: 4.2,
    isNearest: false,
  ...
  {
    id: "shop-mumbai-west",
    name: "TyreSaathi Partner Wheels — West",
    ownerName: "Verified Partner",
    phone: "",
    rating: 4.7,
    reviewsCount: 145,
    address: "Link Road, Metro Corridor Area, Andheri, Mumbai, Maharashtra",
    city: "Mumbai",
    distanceKm: 5.0,
    isNearest: false,
    coordinates: { lat: 19.1363, lng: 72.8277 },
    servicesOffered: ["Tubeless Specialist", "Nitrogen Air", "Alloy Wheels"],
    isOpen: true
  },
  {
    id: "shop-erode-hub",
    name: "TyreSaathi Service Hub — Erode",
    ownerName: "Verified Partner",
    phone: "",
    rating: 4.6,
    reviewsCount: 76,
    address: "Main Road, Commercial Center, Erode, Tamil Nadu",
    city: "Erode",
    distanceKm: 3.5,
    isNearest: false,
    coordinates: { lat: 11.3410, lng: 77.7172 },
    servicesOffered: ["All Vehicle Tyres", "Wheel Balancing", "Tube Repair"],
    isOpen: true
  }
];
...
export const INITIAL_FEATURED_PRODUCTS = [
  ...
  },
  {
    ...
    shopName: "TyreSaathi Express Center",
    shopPhone: "",
    distanceKm: 2.8,
    isNearest: true,
    images: [
  ...
  },
  {
    ...
    published: true,
    condition: "new",
    shopId: "shop-erode-hub",
    shopName: "TyreSaathi Service Hub",
    shopPhone: "",
    distanceKm: 3.5,
    isNearest: false,
    images: [
  ...
  },
  {
    ...
    published: true,
    condition: "new",
    shopId: "shop-delhi-ncr",
    shopName: "TyreSaathi Super Hub",
    shopPhone: "",
    distanceKm: 4.2,
    isNearest: false,
    images: [
