...
export const SAMPLE_SHOPS = [
  {
    id: "shop-blr-central",
    name: "TyreSaathi Partner Hub — Central",
    ownerName: "Verified Partner",
    phone: "",
    rating: 4.8,
    reviewsCount: 128,
    address: "Near Auto Complex, Central Market Area, Bengaluru, Karnataka",
    city: "Bengaluru",
    distanceKm: 1.2,
    isNearest: true,
  ...
  {
    id: "shop-blr-south",
    name: "TyreSaathi Express Center — South",
    ownerName: "Verified Partner",
    phone: "",
    rating: 4.7,
    reviewsCount: 94,
    address: "Main Road, Near Petrol Station, South Zone, Bengaluru, Karnataka",
    city: "Bengaluru",
    distanceKm: 2.8,
    isNearest: true,
